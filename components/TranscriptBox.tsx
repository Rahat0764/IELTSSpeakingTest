...
export default function TranscriptBox({ transcript, fillerCount }: Props) {
  return (
    <div className="bg-card/80 backdrop-blur-md p-5 rounded-xl border border-blue-500/20 shadow-inner transition-all">
      ...
      <p className="min-h-[60px] text-gray-200 text-lg leading-relaxed whitespace-pre-wrap">
        {transcript || <span className="text-gray-500 italic">Speak now...</span>}
      </p>
    </div>
  );
}